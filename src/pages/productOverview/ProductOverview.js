...
export default class ProductOverview extends Component {
  ...
  deleteProduct = () => {
    this.props.deleteProduct(this.state.id || this.props.location.pathname.split("/").slice(-1)[0]
    ).then(res=>{
              ...
              <div className={styles.context_outbox}>
                <div className={styles.context}>
                  ...
                  <div className={styles.btns}>
                    ...
                    <Button className={styles.btn} onClick={this.buyNow} variant="outline-danger">Buy Now</Button>
                    <Button className={styles.btn} onClick={this.deleteProduct} variant="outline-danger">Delete</Button>
                  </div>
                </div>
              </div>
            </div>
